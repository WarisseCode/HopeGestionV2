...
exports.buildOwnerWhereClause = exports.checkPermission = exports.filterByOwner = exports.checkOwnerAccess = void 0;
...
const checkOwnerAccess = async (req, res, next) => {
    try {
        ...
        const accessResult = await database_1.default.query(`SELECT 1 FROM owner_user 
             WHERE owner_id = $1 AND user_id = $2 AND is_active = TRUE`, [ownerId, userId]);
...
const filterByOwner = async (req, res, next) => {
    try {
        ...
        const ownersResult = await database_1.default.query(`SELECT DISTINCT owner_id FROM owner_user 
...
const checkPermission = (permission) => {
    return async (req, res, next) => {
        try {
            ...
            const result = await database_1.default.query(`SELECT ${permission} FROM owner_user 
                 WHERE owner_id = $1 AND user_id = $2 AND is_active = TRUE`, [ownerId, userId]);
 ...
 */
const buildOwnerWhereClause = (ownerIds) => {
    if (ownerIds === null) {
...
exports.buildOwnerWhereClause = buildOwnerWhereClause;
exports.default = {
    checkOwnerAccess: exports.checkOwnerAccess,
    filterByOwner: exports.filterByOwner,
    checkPermission: exports.checkPermission,
    buildOwnerWhereClause: exports.buildOwnerWhereClause
};
//# sourceMappingURL=ownerIsolation.js.map