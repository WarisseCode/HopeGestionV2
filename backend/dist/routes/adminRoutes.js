...
router.get('/stats', async (req, res) => {
    try {
        ...
        const usersCountPromise = database_1.default.query('SELECT COUNT(*) FROM users');
        const activeUsersPromise = database_1.default.query("SELECT COUNT(*) FROM users WHERE statut = 'actif'");
        const propertiesCountPromise = database_1.default.query('SELECT COUNT(*) FROM biens'); // Fixed table name assumption to 'biens' based on error context likely favoring French
        ...
        try {
            ...
            const revRes = await database_1.default.query('SELECT SUM(montant) as total FROM paiements WHERE statut = \'paye\'');
