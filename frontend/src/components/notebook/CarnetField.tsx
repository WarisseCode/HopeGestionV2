...
const CarnetField: React.FC = () => {
    ...
    const getTypeColor = (t: string) => {
        switch(t) {
            ...
            default: return 'bg-gray-100 dark:bg-slate-800/50 text-gray-800 dark:text-gray-100';
        }
    };
    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <h2 className="text-xl font-bold text-gray-800 dark:text-gray-100">Journal Terrain</h2>
                ...
                <Card className="p-4 border-2 border-green-500/20 animate-in fade-in slide-in-from-top-4">
                    ...
                    <div className="space-y-4">
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Type d'action</label>
                                <select 
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Localisation</label>
                                <div className="flex gap-2">
                                    <input 
                                        readOnly 
                                        className="w-full border rounded-lg p-2 bg-gray-50 dark:bg-slate-900/50 text-xs"
                         ...
                         <div>
                            <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Description / Constat</label>
                            <textarea 
            ...
            <div className="relative border-l-2 border-gray-200 dark:border-slate-700 ml-4 space-y-8">
                {actions.map((action, index) => (
                    <div key={action.id} className="relative pl-8">
                        ...
                        <Card className="p-4 hover:shadow-md transition-shadow">
                            ...
                            <p className="text-gray-800 dark:text-gray-100 text-sm whitespace-pre-wrap">{action.description}</p>
