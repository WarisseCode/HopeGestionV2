          ...
          >
            ...
            {currentStep === 0 && (
              <div className="space-y-6">
                <div className="flex flex-col items-center justify-center gap-4">
                   <div className="w-32 h-32 rounded-full overflow-hidden shadow-lg border-4 border-white ring-1 ring-gray-100 bg-gray-50 dark:bg-slate-900/50">
                      <ImageUpload 
                   ...
                   <span className="text-xs text-gray-500 dark:text-gray-400 font-medium">Photo de profil</span>
                </div>
            ...
            {currentStep === 2 && (
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-3 p-4 bg-gray-50 dark:bg-slate-900/50 rounded-xl">
                  ...
                  />
                  <label htmlFor="paiement_echelonne" className="text-sm font-medium text-gray-700 dark:text-gray-200">
            ...
            {currentStep === 3 && (
              <div className="space-y-6">
                ...
                {locataire?.id && (
                  <div className="p-4 bg-gray-50 dark:bg-slate-900/50 rounded-xl space-y-3">
                    <p className="text-sm font-medium text-gray-700 dark:text-gray-200">Actions rapides</p>
