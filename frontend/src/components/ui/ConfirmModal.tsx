            ...
            {isOpen && (
                <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
                    ...
                    <motion.div
                        ...
                        className="relative bg-white dark:bg-slate-800 rounded-2xl shadow-xl w-full max-w-sm overflow-hidden z-10"
                    >
                        {/* Close button */}
                        {!isLoading && (
                            <button 
                                onClick={onClose}
                                className="absolute top-4 right-4 text-gray-400 hover:text-gray-600 dark:text-gray-300 transition"
                            >
                                <X size={20} />
                            </button>
                        )}
                        ...
                        <div className="p-6 text-center">
                            ...
                            <div className="flex gap-3 justify-center">
                                <button
                                    onClick={onClose}
                                    disabled={isLoading}
                                    className="px-4 py-2 text-sm font-medium text-gray-600 dark:text-gray-300 bg-gray-100 dark:bg-slate-800/50 hover:bg-gray-200 rounded-lg transition disabled:opacity-50"
                                >
                                    {cancelLabel}
                                </button>
                                <button
