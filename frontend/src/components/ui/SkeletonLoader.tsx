...
export const SkeletonKPI: React.FC<{ className?: string }> = ({ className = '' }) => {
  return (
    <div className={`bg-base-100 rounded-2xl p-6 border border-base-200 ${className}`}>
...
export const SkeletonTable: React.FC<{
  ...
  return (
    <div className={`bg-base-100 rounded-xl overflow-hidden border border-base-200 ${className}`}>
      {/* Header */}
      <div className="bg-base-200 px-6 py-4 flex gap-4">
      ...
      {Array.from({ length: rows }).map((_, rowIndex) => (
        <div key={rowIndex} className="px-6 py-4 flex gap-4 border-t border-base-200">
