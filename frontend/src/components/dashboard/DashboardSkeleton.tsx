        ...
        <div className="xl:col-span-2 space-y-8">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[1, 2].map((i) => (
                <div key={i} className="bg-white dark:bg-slate-800 rounded-2xl p-4 shadow-lg border border-gray-100 dark:border-slate-700/50 flex gap-4">
...
export const ChartSkeleton: React.FC<{ height?: number }> = ({ height = 350 }) => (
  <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-lg border border-gray-100 dark:border-slate-700/50 animate-pulse">
    <div className="flex justify-between items-center mb-6">
      <div className="space-y-2">
        <SkeletonLoader variant="text" width={200} height={24} />
        <SkeletonLoader variant="text" width={150} height={16} />
