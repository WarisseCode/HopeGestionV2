                        ...
                        >
                            ...
                            {currentStep === 0 && (
                                <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                        <div className="space-y-4">
                                            <div className="flex items-center justify-between">
                                                <label className="text-sm font-bold text-base-content/80 uppercase tracking-wide">Locataire</label>
                                                {formData.tenant_id > 0 && <Check size={16} className="text-green-500" />}
                                            </div>
                                            <select
                                                className={`w-full p-4 bg-base-100 border border-base-300 rounded-xl focus:ring-2 focus:ring-blue-100 focus:border-blue-500 transition shadow-sm outline-none appearance-none ${isEditing ? 'opacity-60 cursor-not-allowed' : ''}`}
                                        ...
                                        <div className="space-y-4">
                                            <div className="flex items-center justify-between">
                                                <label className="text-sm font-bold text-base-content/80 uppercase tracking-wide">Lot à louer</label>
                                        ...
                                        <div className="md:col-span-2 space-y-4">
                                            <div className="flex items-center justify-between">
                                                <label className="text-sm font-bold text-base-content/80 uppercase tracking-wide">Propriétaire concerné</label>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-4 pt-4 border-t border-base-200">
                                        <div className="space-y-4">
                                            <label className="text-sm font-bold text-base-content/80 uppercase tracking-wide">Date de début</label>
                                            <input 
                                                type="date"
                                                className="w-full p-4 bg-base-100 border border-base-300 rounded-xl focus:ring-2 focus:ring-blue-100 outline-none transition"
                                                value={formData.date_debut}
                                                onChange={e => setFormData({...formData, date_debut: e.target.value})}
                                            />
                                        </div>
                                        <div className="space-y-4">
                                            <label className="text-sm font-bold text-base-content/80 uppercase tracking-wide">Date de fin (Optionnel)</label>
                                            <input 
                                                type="date"
                                                className="w-full p-4 bg-base-100 border border-base-300 rounded-xl focus:ring-2 focus:ring-blue-100 outline-none transition"
                                ...
                                <div className="space-y-8">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div className="space-y-3">
                                            <label className="text-sm font-bold text-base-content/80">Durée du contrat</label>
                                            <input 
                                                type="number"
                                                className="w-full p-4 bg-base-100 border border-base-300 rounded-xl focus:ring-2 focus:ring-blue-100 outline-none transition"
                                        ...
                                        <div className="space-y-3">
                                            <label className="text-sm font-bold text-base-content/80">Loyer Mensuel</label>
                                            <div className="relative">
                                                <input 
                                                    type="number"
                                                    className="w-full p-4 pl-10 bg-base-100 border border-base-300 rounded-xl focus:ring-2 focus:ring-blue-100 outline-none transition"
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            <div className="space-y-3">
                                                <label className="text-sm font-bold text-base-content/80">Type de charges</label>
                                                <select
                                                    className="w-full p-4 bg-base-100 border border-base-300 rounded-xl focus:ring-2 focus:ring-blue-100 outline-none transition"
                                            ...
                                            <div className="space-y-3">
                                                <label className="text-sm font-bold text-base-content/80">Montant Mensuel</label>
                                                <input 
                                                    type="number"
                                                    className="w-full p-4 bg-base-100 border border-base-300 rounded-xl focus:ring-2 focus:ring-blue-100 outline-none transition"
                                        ...
                                        <div className="space-y-3">
                                            <label className="text-sm font-bold text-base-content/80">Caution</label>
                                            <input 
                                                type="number"
                                                className="w-full p-4 bg-base-100 border border-base-300 rounded-xl focus:ring-2 focus:ring-blue-100 outline-none transition"
                                        ...
                                        <div className="space-y-3">
                                            <label className="text-sm font-bold text-base-content/80">Avance</label>
                                            <input 
                                                type="number"
                                                className="w-full p-4 bg-base-100 border border-base-300 rounded-xl focus:ring-2 focus:ring-blue-100 outline-none transition"
                                ...
                                <div className="space-y-8">
                                    <div className="p-6 bg-purple-50 rounded-2xl border border-purple-100">
                                        ...
                                        <div className="space-y-6">
                                            <div className="flex gap-4">
                                                <button
                                                    ...
                                                    className={`flex-1 p-4 rounded-xl border-2 transition text-center font-bold ${
                                                        ...
                                                        ? 'border-purple-500 bg-base-100 text-purple-600 shadow-sm' 
                                                        : 'border-transparent bg-purple-100/50 text-base-content/60 hover:bg-purple-100'
                                                    }`}
                                                >
                                                    Mensuel Classique
                                                </button>
                                            ...
                                            {formData.type_paiement === 'echelonne' && (
                                                <div className="animate-in slide-in-from-top-4">
                                                    <div className="grid grid-cols-2 gap-4 mb-4">
                                                        <div>
                                                            <label className="text-xs font-bold uppercase text-base-content/60">Fréquence</label>
                                                            <select
                                                                className="w-full mt-1 p-3 bg-base-100 border rounded-lg"
                                                        ...
                                                        <div>
                                                            <label className="text-xs font-bold uppercase text-base-content/60">Nb échéances</label>
                                                            <input 
                                                                type="number"
                                                                className="w-full mt-1 p-3 bg-base-100 border rounded-lg"
                                            ...
                                            <div className="grid grid-cols-2 gap-4">
                                                <div>
                                                    <label className="text-sm font-bold text-base-content/80">Jour d'échéance</label>
                                                    <input 
                                                        type="number"
                                                        max="31"
                                                ...
                                                <div>
                                                    <label className="text-sm font-bold text-base-content/80">Devise</label>
                                                    <select
                                                        className="w-full p-3 bg-base-100 border border-base-300 rounded-xl"
