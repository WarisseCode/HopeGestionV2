  ...
  return (
    <div className="flex flex-col h-full bg-base-100 p-6 max-w-4xl mx-auto rounded-xl">
      <div className="text-center mb-8">
        <h2 className="text-2xl font-bold text-base-content">Affectation du Lot {lot.reference}</h2>
        <p className="text-base-content/60 text-sm mt-1">{lot.type} - {lot.superficie} m²</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-6">
          ...
          {/* 1. Choix du client */}
          <div className="card bg-base-100 border border-base-200 p-4 shadow-sm z-50"> 
            <label className="label text-sm font-semibold text-base-content/80">Client (Locataire/Acheteur)</label>
            ...
            {!selectedClient ? (
              <div className="relative">
                ...
                {clientSearch.length > 1 && (
                  <div className="absolute top-full left-0 right-0 bg-base-100 shadow-xl border border-base-200 rounded-lg mt-1 max-h-60 overflow-y-auto z-50">
                    {clients.length > 0 ? (
                      clients.map(client => (
                        <div 
                          key={client.id}
                        ...
                        >
                          ...
                          <div>
                            ...
                            <div className="text-xs text-base-content/60">{client.telephone_principal}</div>
                          </div>
              ...
              <div className="flex items-center justify-between bg-primary/5 p-3 rounded-lg border border-primary/20">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-bold text-base-content">{selectedClient.nom} {selectedClient.prenoms}</div>
          ...
          <div className="card bg-base-100 border border-base-200 p-4 shadow-sm">
            <label className="label text-sm font-semibold text-base-content/80">Type d'affectation</label>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-base-100 p-6 rounded-xl border border-base-200 shadow-sm relative overflow-hidden">
