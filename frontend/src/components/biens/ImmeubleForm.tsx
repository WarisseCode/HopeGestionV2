                        ...
                        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                             <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700/50 space-y-6">
                                ...
                                <Input
                                    ...
                                    required
                                    className={`bg-gray-50 dark:bg-slate-900/50 border-gray-200 dark:border-slate-700 focus:bg-white dark:bg-slate-800 ${!formData.nom ? 'border-red-200 focus:border-red-500' : ''}`}
                                />
                                ...
                                <div className="grid grid-cols-2 gap-6">
                                    ...
                                    <Input
                                        ...
                                        placeholder="Ex: 12"
                                        required
                                        className={`bg-gray-50 dark:bg-slate-900/50 border-gray-200 dark:border-slate-700 focus:bg-white dark:bg-slate-800 ${!formData.total_lots ? 'border-red-200' : ''}`}
                                    />
                                </div>
                                <div className="form-control">
                                    <label className="label font-bold text-sm text-gray-700 dark:text-gray-200">Description</label>
                                    <textarea
                                        className="textarea textarea-bordered h-32 bg-gray-50 dark:bg-slate-900/50 border-gray-200 dark:border-slate-700 focus:bg-white dark:bg-slate-800 w-full rounded-xl p-4 text-sm"
                            ...
                            <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700/50 space-y-6">
                                ...
                                <div className="grid grid-cols-2 gap-6">
                                    ...
                                    <Input
                                        ...
                                        required
                                        className={`bg-gray-50 dark:bg-slate-900/50 border-gray-200 dark:border-slate-700 focus:bg-white dark:bg-slate-800 ${!formData.ville ? 'border-red-200' : ''}`}
                                    />
                                </div>
                                <Input
                                    label="Pays"
                                ...
                                <div className="p-4 bg-blue-50 rounded-xl border border-blue-100">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <Input
                                            ...
                                            placeholder="6.3702"
                                            className="bg-white dark:bg-slate-800 border-blue-200"
                                        />
                                        <Input
                                            label="Longitude"
                                            type="number"
                                ...
                                <div className="space-y-4">
                                     {proprietaires.length > 1 ? (
                                        <div className="form-control w-full">
                                            <label className="label font-bold text-sm text-gray-700 dark:text-gray-200">Propriétaire *</label>
                                            <select
                                                className={`select select-bordered w-full bg-gray-50 dark:bg-slate-900/50 border-gray-200 dark:border-slate-700 focus:bg-white dark:bg-slate-800 h-12 ${!formData.owner_id ? 'select-error' : ''}`}
                                     ...
                                     {gestionnaires.length > 0 && (
                                         <div className="form-control w-full mt-4">
                                            <label className="label font-bold text-sm text-gray-700 dark:text-gray-200">Gestionnaire (Optionnel)</label>
                                            <select
                                                className="select select-bordered w-full bg-gray-50 dark:bg-slate-900/50 border-gray-200 dark:border-slate-700 focus:bg-white dark:bg-slate-800 h-12"
