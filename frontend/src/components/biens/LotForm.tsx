        ...
        <div className="max-w-4xl mx-auto px-2 pb-12">
            <AnimatePresence mode="wait">
                 ...
                 >
                                ...
                                <div className="space-y-4">
                                     {immeubles.length > 1 ? (
                                        <Select
                                            ...
                                            className={`bg-gray-50 dark:bg-slate-900/50 border-gray-200 dark:border-slate-700 focus:bg-white dark:bg-slate-800 ${!formData.building_id ? 'border-red-200' : ''}`}
                                        />
                                     ) : immeubles.length === 1 ? (
                                     ...
                                     <div className="grid grid-cols-2 gap-6">
                                        <Input
                                            ...
                                            required
                                            className={`bg-gray-50 dark:bg-slate-900/50 border-gray-200 dark:border-slate-700 focus:bg-white dark:bg-slate-800 ${!formData.reference ? 'border-red-200' : ''}`}
                                        />
                                        <Select
                                            label="Type de lot *"
                                            ...
                                            options={TYPES_LOT}
                                            className="bg-gray-50 dark:bg-slate-900/50 border-gray-200 dark:border-slate-700 focus:bg-white dark:bg-slate-800"
                                        />
                                     </div>
                                </div>
                             </div>
                         ...
                         <div className="space-y-6">
                             <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700/50 space-y-6">
                                ...
                                <div className="form-control">
                                    <label className="label font-bold text-sm text-gray-700 dark:text-gray-200">Description détaillée</label>
                                    <textarea
                                        className="textarea textarea-bordered h-40 bg-gray-50 dark:bg-slate-900/50 border-gray-200 dark:border-slate-700 focus:bg-white dark:bg-slate-800 w-full rounded-xl p-4"
                    ...
                    {currentStep === 2 && (
                        <div className="space-y-6">
                             <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-blue-100 space-y-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    <Input
                                        ...
                                        className="font-mono bg-gray-50 dark:bg-slate-900/50 border-gray-200 dark:border-slate-700 focus:bg-white dark:bg-slate-800 text-lg font-bold text-gray-700 dark:text-gray-200"
                                    />
                                    <Input
                                        ...
                                        placeholder="Ex: 5000"
                                        className="font-mono bg-gray-50 dark:bg-slate-900/50 border-gray-200 dark:border-slate-700 focus:bg-white dark:bg-slate-800"
                                    />
                                    <Select
                                ...
                                <div className="grid grid-cols-2 gap-6">
                                    <div className="p-4 bg-gray-50 dark:bg-slate-900/50 rounded-xl">
                                        <Input
                                            ...
                                            className="font-mono"
                                        />
                                        <span className="text-xs text-gray-500 dark:text-gray-400 mt-2 block">Habituellement 2-3 mois de loyer.</span>
                                    </div>
                                    <div className="p-4 bg-gray-50 dark:bg-slate-900/50 rounded-xl">
                                        <Input
                                            label="Avance (mois)"
                                        ...
                                        />
                                         <span className="text-xs text-gray-500 dark:text-gray-400 mt-2 block">Mois payés d'avance à l'entrée.</span>
                                    </div>
                                </div>
                             </div>

                             {/* VENTE OPTION */}
                             <div className={`card transition-all duration-300 ${showVenteFields ? 'border-green-200 bg-white dark:bg-slate-800 shadow-md ring-1 ring-green-100' : 'border border-gray-200 dark:border-slate-700 bg-gray-50 dark:bg-slate-900/50 opacity-80'}`}>
                                <div className="px-6 py-4 flex items-center justify-between cursor-pointer" onClick={() => setShowVenteFields(!showVenteFields)}>
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <h3 className={`font-bold ${showVenteFields ? 'text-green-900' : 'text-gray-600 dark:text-gray-300'}`}>Option de Vente</h3>
                                            <p className="text-xs text-gray-500 dark:text-gray-400">Activer si ce lot est disponible à l'achat</p>
                                        </div>
                                    </div>
                                    <input 
                                        type="checkbox" 
                                    ...
                                    <div className="p-6 pt-0 animate-in slide-in-from-top-2">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                            <Input
                                                ...
                                                className="font-mono text-lg font-bold text-green-700 bg-green-50/50 border-green-100 focus:bg-white dark:bg-slate-800"
                                            />
                                            <Select
                        ...
                        <div className="space-y-6">
                            <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700/50 space-y-6">
                                <div className="flex items-center justify-between mb-4">
                                    ...
                                    <span className="text-xs font-bold text-gray-500 dark:text-gray-400 bg-gray-100 dark:bg-slate-800/50 px-3 py-1 rounded-full">{photoPreviews.length}/10 photos</span>
                                </div>
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                    ...
                                    <div key={index} className="relative group aspect-square">
                                        <img 
                                            src={url} 
                                            alt={`Photo ${index + 1}`} 
                                            className="w-full h-full object-cover rounded-xl shadow-sm border border-gray-200 dark:border-slate-700 transition-transform duration-200 group-hover:scale-[1.02]"
                                        />
                                    ...
                                    <ImageUpload 
                                        ...
                                        folder="property"
                                        label=""
                                        className="aspect-square bg-gray-50 dark:bg-slate-900/50 border-dashed border-2 border-gray-200 dark:border-slate-700 hover:border-blue-300 hover:bg-blue-50 transition-colors rounded-xl"
                                        clearOnSuccess={true}
                                    />
                                    )}
                                </div>
