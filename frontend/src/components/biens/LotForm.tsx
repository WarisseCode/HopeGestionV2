        ...
        <div className="max-w-4xl mx-auto px-2 pb-12">
            <AnimatePresence mode="wait">
                 ...
                 >
                                ...
                                <div className="space-y-4">
                                     {immeubles.length > 1 ? (
                                        <Select
                                            ...
                                            className={`bg-base-200 border-base-300 focus:bg-base-100 ${!formData.building_id ? 'border-red-200' : ''}`}
                                        />
                                     ) : immeubles.length === 1 ? (
                                     ...
                                     <div className="grid grid-cols-2 gap-6">
                                        <Input
                                            ...
                                            required
                                            className={`bg-base-200 border-base-300 focus:bg-base-100 ${!formData.reference ? 'border-red-200' : ''}`}
                                        />
                                        <Select
                                            label="Type de lot *"
                         ...
                         <div className="space-y-6">
                             <div className="bg-base-100 p-6 rounded-2xl shadow-sm border border-base-200 space-y-6">
                                ...
                                <div className="form-control">
                                    <label className="label font-bold text-sm text-base-content/80">Description détaillée</label>
                                    <textarea
                                        className="textarea textarea-bordered h-40 bg-base-200 border-base-300 focus:bg-base-100 w-full rounded-xl p-4"
                    ...
                    {currentStep === 2 && (
                        <div className="space-y-6">
                             <div className="bg-base-100 p-6 rounded-2xl shadow-sm border border-blue-100 space-y-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    <Input
                                        ...
                                        className="font-mono bg-base-200 border-base-300 focus:bg-base-100 text-lg font-bold text-base-content/80"
                                    />
                                    <Input
                                        ...
                                        placeholder="Ex: 5000"
                                        className="font-mono bg-base-200 border-base-300 focus:bg-base-100"
                                    />
                                    <Select
                                ...
                                <div className="grid grid-cols-2 gap-6">
                                    <div className="p-4 bg-base-200 rounded-xl">
                                        <Input
                                            ...
                                            className="font-mono"
                                        />
                                        <span className="text-xs text-base-content/60 mt-2 block">Habituellement 2-3 mois de loyer.</span>
                                    </div>
                                    <div className="p-4 bg-base-200 rounded-xl">
                                        <Input
                                            label="Avance (mois)"
                                        ...
                                        />
                                         <span className="text-xs text-base-content/60 mt-2 block">Mois payés d'avance à l'entrée.</span>
                                    </div>
                                </div>
                             </div>
                             ...
                             <div className={`card transition-all duration-300 ${showVenteFields ? 'border-green-200 bg-base-100 shadow-md ring-1 ring-green-100' : 'border border-base-300 bg-base-200 opacity-80'}`}>
                                <div className="px-6 py-4 flex items-center justify-between cursor-pointer" onClick={() => setShowVenteFields(!showVenteFields)}>
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <h3 className={`font-bold ${showVenteFields ? 'text-green-900' : 'text-base-content/70'}`}>Option de Vente</h3>
                                            <p className="text-xs text-base-content/60">Activer si ce lot est disponible à l'achat</p>
                                        </div>
                                    </div>
                                    <input 
                                        type="checkbox" 
                                    ...
                                    <div className="p-6 pt-0 animate-in slide-in-from-top-2">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                            <Input
                                                ...
                                                className="font-mono text-lg font-bold text-green-700 bg-green-50/50 border-green-100 focus:bg-base-100"
                                            />
                                            <Select
                        ...
                        <div className="space-y-6">
                            <div className="bg-base-100 p-6 rounded-2xl shadow-sm border border-base-200 space-y-6">
                                <div className="flex items-center justify-between mb-4">
                                    ...
                                    <span className="text-xs font-bold text-base-content/60 bg-base-300 px-3 py-1 rounded-full">{photoPreviews.length}/10 photos</span>
                                </div>
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                    ...
                                    <div key={index} className="relative group aspect-square">
                                        <img 
                                            src={url} 
                                            alt={`Photo ${index + 1}`} 
                                            className="w-full h-full object-cover rounded-xl shadow-sm border border-base-300 transition-transform duration-200 group-hover:scale-[1.02]"
                                        />
