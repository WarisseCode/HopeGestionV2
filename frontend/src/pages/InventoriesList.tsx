...
const InventoriesList: React.FC = () => {
    ...
    const getStatusBadge = (status: string) => {
        switch (status) {
            ...
            case 'archive':
                return <span className="px-2 py-1 rounded-full text-xs font-bold bg-base-300 text-base-content/80 flex items-center gap-1"><Clock size={10} /> Archivé</span>;
            default:
                return null;
        }
    };
                            ...
                            <div key={inv.id} className="p-4 hover:bg-base-200 transition-colors flex flex-col md:flex-row md:items-center gap-4">
                                ...
                                <div className="flex-1">
                                    <div className="flex items-center gap-2 mb-1">
                                        <h3 className="font-semibold text-base-content">{getTypeLabel(inv.type_inventaire)}</h3>
