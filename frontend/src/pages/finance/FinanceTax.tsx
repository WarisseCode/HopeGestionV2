    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                 ...
                 <Card>
                    ...
                    <div className="space-y-4">
                        <div className="relative">
                            <label className="block text-sm font-bold text-gray-700 dark:text-gray-200 mb-1">Propriétaire / Entité</label>
                            <div className="dropdown w-full">
                                <div 
                                    tabIndex={0} 
                                    role="button" 
                                    className="btn btn-outline w-full justify-between bg-white dark:bg-slate-800 text-black hover:bg-gray-100 dark:bg-slate-800/50 hover:text-black font-normal"
                                >
                                    {selectedOwner 
                                ...
                                <ul tabIndex={0} className="dropdown-content z-[1] menu p-2 shadow bg-white dark:bg-slate-800 rounded-box w-full mt-1 border border-gray-200 dark:border-slate-700">
                                    {owners.map(o => (
                                        <li key={o.id}>
                                            <button 
                                                onClick={() => {
                        ...
                        {selectedOwner && (
                            <>
                                <div>
                                    <label className="block text-sm font-bold text-gray-700 dark:text-gray-200 mb-1">Régime Fiscal</label>
                                    <select 
            ...
            <div className="lg:col-span-2">
                {!selectedOwner ? (
                    <div className="h-full flex flex-col items-center justify-center bg-gray-50 dark:bg-slate-900/50 rounded-xl border border-dashed border-gray-300 p-12 text-gray-400">
                    ...
                    <div className="space-y-6">
                        <Card className="bg-gradient-to-br from-blue-900 to-blue-800 text-white border-none">
                            <div className="flex justify-between items-center mb-6">
                                ...
                                <Button variant="secondary" onClick={generateReport} disabled={loading} className="bg-white dark:bg-slate-800/10 text-white hover:bg-white dark:bg-slate-800/20 border-none">
                            ...
                            {report ? (
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
                                    ...
                                    <div className="bg-white dark:bg-slate-800/10 p-6 rounded-xl flex flex-col justify-center items-center text-center">
