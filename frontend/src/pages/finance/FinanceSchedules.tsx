        ...
        <div className="space-y-6">
            ...
            <div className="bg-base-100 rounded-2xl p-4 shadow-sm border border-base-200">
                <div className="flex justify-between items-center mb-2">
                    <span className="text-sm font-bold text-base-content/80">Taux de recouvrement</span>
                                        ...
                                        <div>
                                            ...
                                            <div className="flex items-center gap-3 text-xs text-base-content/60 mt-1">
                                                {schedule.lot_reference && (
                                                    <span className="bg-base-300 px-2 py-0.5 rounded-md">🏠 {schedule.lot_reference}</span>
                                                )}
                                                {schedule.reference_bail && (
                                                    <span className="bg-base-300 px-2 py-0.5 rounded-md">📋 {schedule.reference_bail}</span>
                                                )}
            ...
            >
                {selectedSchedule && (
                    <div className="space-y-5">
                        ...
                        <div>
                            <label className="block text-sm font-semibold text-base-content/80 mb-2">Mode de paiement</label>
                            <select
                                value={paymentMethod}
                                onChange={(e) => setPaymentMethod(e.target.value)}
                                className="w-full border border-base-300 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-primary/30 focus:border-primary outline-none"
                            >
                        ...
                        <div>
                            <label className="block text-sm font-semibold text-base-content/80 mb-2">Référence (optionnel)</label>
                            <input
                                type="text"
                                value={paymentRef}
