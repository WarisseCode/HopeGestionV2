        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}>
          <Card className="bg-gradient-to-br from-primary to-primary-focus text-primary-content border-none">
            <div className="flex justify-between items-start">
              ...
              <div className="p-3 bg-white dark:bg-slate-800/20 rounded-xl">
                <DollarSign size={24} />
              </div>
            </div>
            <div className="mt-4 flex items-center text-sm font-medium bg-white dark:bg-slate-800/10 w-fit px-2 py-1 rounded">
