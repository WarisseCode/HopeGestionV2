      ...
      <motion.div variants={itemVariants} className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-3 flex-wrap">
            ...
            {managerCode && (
                ...
                >
                    <span className="text-xs text-gray-500 dark:text-gray-400 font-medium uppercase">Code Agence:</span>
             ...
             <motion.div variants={itemVariants}>
                <Card className="overflow-hidden border-none shadow-xl bg-white dark:bg-slate-800">
                    <div className="flex justify-between items-center mb-6 px-2">
                        <div>
                            <h3 className="text-xl font-bold text-gray-800 dark:text-gray-100">Performance Financière</h3>
                            <p className="text-sm text-gray-500 dark:text-gray-400">Revenus locatifs bruts vs charges</p>
                        </div>
            ...
            <motion.div variants={itemVariants}>
                ...
                {loadingWidgets ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {[1, 2].map(i => <div key={i} className="h-24 bg-gray-100 dark:bg-slate-800/50 rounded-xl animate-pulse"></div>)}
                    </div>
                    ...
                    <p className="text-center text-gray-500 dark:text-gray-400 py-8 bg-white dark:bg-slate-800 rounded-xl">Aucune propriété affichée.</p>
                )}
            </motion.div>
        </div>
        ...
        <div className="space-y-8">
            ...
            <motion.div variants={itemVariants}>
                <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-lg border border-gray-100 dark:border-slate-700/50">
                    <h3 className="font-bold text-gray-800 dark:text-gray-100 mb-4">Accès Rapide</h3>
                    ...
                    <div className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-2xl p-6 shadow-lg text-white">
                        ...
                        <div className="flex gap-2">
                            <button
                                ...
                                className="flex items-center gap-2 bg-white dark:bg-slate-800/20 hover:bg-white dark:bg-slate-800/30 backdrop-blur-sm text-white text-sm font-semibold px-3 py-2 rounded-lg transition-all"
                            >
                                <Copy size={14} /> Copier
                            </button>
                            <button
            ...
            <motion.div variants={itemVariants}>
                 <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-lg border border-gray-100 dark:border-slate-700/50 relative overflow-hidden">
                    <h3 className="font-bold text-gray-800 dark:text-gray-100 mb-2">Taux d'Occupation</h3>
                    <div className="h-[200px] flex items-center justify-center relative z-10">
                        ...
                        <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                            <span className="text-3xl font-extrabold text-gray-800 dark:text-gray-100">{stats?.tauxOccupation || 83}%</span>
            ...
            <motion.div variants={itemVariants}>
                <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-lg border border-gray-100 dark:border-slate-700/50">
                    <h3 className="font-bold text-gray-800 dark:text-gray-100 mb-4">Échéances</h3>
