        ...
        <div className="max-w-[1600px] mx-auto space-y-6">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                <div>
                    ...
                    <p className="text-base-content/60">Mémoire terrain, contacts et notes</p>
                </div>
            </div>

            {/* Tabs */}
            <div className="bg-base-100 rounded-xl shadow-sm p-1 inline-flex gap-1">
                <button
                    onClick={() => setViewMode('notes')}
                    className={`px-4 py-2 rounded-lg text-sm font-medium flex items-center gap-2 transition-all ${
                        viewMode === 'notes' ? 'bg-brand-50 text-brand-700 shadow-sm' : 'text-base-content/60 hover:bg-base-200'
                    }`}
                >
                ...
                <button
                    ...
                    className={`px-4 py-2 rounded-lg text-sm font-medium flex items-center gap-2 transition-all ${
                        viewMode === 'contacts' ? 'bg-brand-50 text-brand-700 shadow-sm' : 'text-base-content/60 hover:bg-base-200'
                    }`}
                >
                ...
                <button
                    ...
                    className={`px-4 py-2 rounded-lg text-sm font-medium flex items-center gap-2 transition-all ${
                        viewMode === 'field' ? 'bg-brand-50 text-brand-700 shadow-sm' : 'text-base-content/60 hover:bg-base-200'
                    }`}
                >
