...
const TenantPayments: React.FC = () => {
    ...
    const getStatusBadge = (status: string) => {
        const configs: Record<string, { color: string; icon: React.ReactNode; label: string }> = {
            ...
            'cancelled': { color: 'bg-base-300 text-base-content/80', icon: <AlertCircle size={14} />, label: 'Annulé' }
        };
        ...
        >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {pendingSchedules.map((schedule) => {
                            ...
                            return (
                                <Card
                                    key={schedule.id}
                                    className={`relative overflow-hidden ${isOverdue ? 'border-red-300 bg-red-50/30' : 'border-base-300'}`}
                                >
                                    {isOverdue && (
                                    ...
                                    <div className="space-y-4">
                                        <div>
                                            <h3 className="font-bold text-lg text-base-content/90">
                                        ...
                                        <div className="space-y-2">
                                            <div className="flex justify-between items-center">
                                                <span className="text-base-content/70">Montant total</span>
                                            ...
                                            <div className="flex justify-between items-center pt-2 border-t">
                                                <span className="font-bold text-base-content/80">Reste à payer</span>
            ...
            {pendingSchedules.length === 0 && (
                <Card className="text-center py-12">
                    ...
                    <h3 className="text-xl font-bold text-base-content/90 mb-2">Tous vos loyers sont à jour !</h3>
                    <p className="text-base-content/60">Aucun paiement en attente</p>
                </Card>
            )}
            ...
            <div className="space-y-4">
                ...
                {transactionHistory.length > 0 ? (
                                ...
                                <tbody className="divide-y divide-gray-100">
                                    {transactionHistory.map((transaction) => (
                                        <tr key={transaction.id} className="hover:bg-base-200">
                                            ...
                                            <td className="p-4 font-mono font-bold text-base-content/90">
                    ...
                    <Card className="text-center py-8 text-base-content/60">
            ...
            >
                {selectedSchedule && (
                    <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                >
                                    <div className="text-center">
                                        ...
                                        <div className="text-xs text-base-content/60">Mobile Money</div>
                                    </div>
                                </button>
                        ...
                        <div className="bg-base-200 p-4 rounded-lg text-sm text-base-content/70">
