...
const PublicReservation: React.FC = () => {
            ...
            <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
                ...
                >
                    ...
                    <p className="text-gray-500 mb-6">
                        Votre référence : <span className="font-mono font-bold text-gray-900 bg-gray-100 px-2 py-1 rounded">{reference}</span><br/>
    ...
    return (
        <div className="min-h-screen bg-gray-100 flex flex-col md:flex-row">
            ...
            <div className="w-full md:w-1/2 lg:w-3/5 h-[300px] md:h-auto relative bg-gray-900 text-white overflow-hidden">
                {lot && (
                    <>
                        ...
                        {/* Map Overlay Preview */}
                        <div className="absolute top-4 right-4 w-32 h-32 bg-white rounded-xl shadow-lg border-2 border-white overflow-hidden opacity-90 hover:opacity-100 transition">
            ...
            {/* RIGHT: Form */}
            <div className="w-full md:w-1/2 lg:w-2/5 md:overflow-y-auto bg-white p-6 md:p-12 shadow-2xl z-10">
                <div className="max-w-md mx-auto">
                    <div className="mb-8">
                        <h2 className="text-sm font-bold text-gray-400 uppercase tracking-widest mb-1">Réservation en ligne</h2>
                        <h3 className="text-3xl font-bold text-gray-900">Sécurisez ce bien</h3>
                    ...
                    <form onSubmit={submitReservation} className="space-y-6">
                        {step === 0 && (
                            <motion.div initial={{x: 20, opacity:0}} animate={{x:0, opacity:1}} className="space-y-4">
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="space-y-1">
                                        ...
                                        <div className="relative">
                                            <input required type="text" className="w-full pl-10 pr-4 py-3 bg-gray-50 border-none rounded-xl focus:ring-2 focus:ring-blue-500" placeholder="Nom"
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <input required type="text" className="w-full px-4 py-3 bg-gray-50 border-none rounded-xl focus:ring-2 focus:ring-blue-500" placeholder="Prénoms"
                                ...
                                <div className="space-y-1">
                                    ...
                                    <div className="relative">
                                        <input required type="tel" className="w-full pl-10 pr-4 py-3 bg-gray-50 border-none rounded-xl focus:ring-2 focus:ring-blue-500" placeholder="+225 07..."
                                ...
                                <div className="space-y-1">
                                    <label className="text-xs font-bold text-gray-500 uppercase">Email (Optionnel)</label>
                                    <div className="relative">
                                        <input type="email" className="w-full pl-10 pr-4 py-3 bg-gray-50 border-none rounded-xl focus:ring-2 focus:ring-blue-500" placeholder="exemple@email.com"
                        ...
                        {step === 1 && (
                            <motion.div initial={{x: 20, opacity:0}} animate={{x:0, opacity:1}} className="space-y-4">
                                <button type="button" onClick={() => setStep(0)} className="text-sm font-bold text-gray-400 hover:text-gray-600 mb-2">← Retour</button>
                                
                                <div className="space-y-1">
                                    <label className="text-xs font-bold text-gray-500 uppercase">Type de Projet</label>
                                    <div className="grid grid-cols-2 gap-3">
                                        <button type="button" 
                                            onClick={() => setFormData({...formData, type_projet: 'location'})}
                                            className={`p-3 rounded-xl border-2 font-bold transition ${formData.type_projet === 'location' ? 'border-blue-500 bg-blue-50 text-blue-600' : 'border-gray-200 text-gray-400'}`}>
                                            Location Simple
                                        </button>
                                        <button type="button" 
                                            onClick={() => setFormData({...formData, type_projet: 'achat'})}
                                            className={`p-3 rounded-xl border-2 font-bold transition ${formData.type_projet === 'achat' ? 'border-blue-500 bg-blue-50 text-blue-600' : 'border-gray-200 text-gray-400'}`}>
                                            Achat / Vente
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-1">
                                    <label className="text-xs font-bold text-gray-500 uppercase">Date souhaitée</label>
                                    <div className="relative">
                                        <input required type="date" className="w-full pl-10 pr-4 py-3 bg-gray-50 border-none rounded-xl focus:ring-2 focus:ring-blue-500"
                                ...
                                <div className="space-y-1">
                                    <label className="text-xs font-bold text-gray-500 uppercase">Message (Optionnel)</label>
                                    <textarea className="w-full px-4 py-3 bg-gray-50 border-none rounded-xl focus:ring-2 focus:ring-blue-500 h-24" 
                ...
                {/* Footer safe area */}
                <div className="mt-8 pt-8 border-t border-gray-100 flex items-center justify-between text-xs text-gray-400 font-medium">
