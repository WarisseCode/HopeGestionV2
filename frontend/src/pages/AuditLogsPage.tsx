...
const AuditLogsPage: React.FC = () => {
    ...
    const getActionColor = (action: string) => {
        ...
        return 'text-gray-600 dark:text-gray-300 bg-gray-100 dark:bg-slate-800/50 border-gray-200 dark:border-slate-700';
    };
        ...
        >
            ...
            <motion.div variants={itemVariants} className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                     ...
                     <p className="text-gray-500 dark:text-gray-400 font-medium mt-1">Surveillez l'activité critique et la sécurité de votre application.</p>
                </div>
            ...
            <motion.div variants={itemVariants}>
                <Card className="bg-white dark:bg-slate-800 border-none shadow-lg mb-6">
                    <div className="flex flex-col md:flex-row gap-4 items-center">
                        <div className="relative flex-1 w-full">
                            ...
                            <input 
                                ...
                                className="input input-bordered w-full pl-11 bg-gray-50 dark:bg-slate-900/50 border-gray-100 dark:border-slate-700/50 focus:bg-white dark:bg-slate-800 focus:border-primary transition-all rounded-xl"
                                value={searchTerm}
                        ...
                        <select 
                            className="select select-bordered w-full md:w-64 bg-gray-50 dark:bg-slate-900/50 border-gray-100 dark:border-slate-700/50 focus:bg-white dark:bg-slate-800 focus:border-primary rounded-xl"
                            value={actionFilter}
                        ...
                        >
                         ...
                         <Button variant="ghost" className="btn-square bg-gray-50 dark:bg-slate-900/50 text-gray-400 hover:text-primary hover:bg-primary/10 rounded-xl">
                            <Filter size={20} />
                        </Button>
                    </div>
                </Card>
            ...
            <motion.div variants={itemVariants}>
                <Card className="border-none shadow-xl bg-white dark:bg-slate-800 p-0 overflow-hidden">
                        ...
                        <table className="table w-full">
                            <thead>
                                <tr className="bg-gray-50 dark:bg-slate-900/50/50">
                                    <th className="py-4 pl-6 text-gray-500 dark:text-gray-400 font-semibold">Horodatage</th>
                                    <th className="text-gray-500 dark:text-gray-400 font-semibold">Action</th>
                                    <th className="text-gray-500 dark:text-gray-400 font-semibold">Utilisateur</th>
                                    <th className="text-gray-500 dark:text-gray-400 font-semibold">IP Source</th>
                                    <th className="pr-6 text-right text-gray-500 dark:text-gray-400 font-semibold">Détails</th>
                                </tr>
                            </thead>
                            <tbody className="divide-y divide-gray-100">
                                {loading ? (
                                    ...
                                    logs.map((log) => (
                                        <tr key={log.id} className="hover:bg-gray-50 dark:bg-slate-900/50/50 transition-colors group">
                                            <td className="pl-6 font-mono text-xs text-gray-500 dark:text-gray-400">
                                            ...
                                            <td>
                                                <div className="flex items-center gap-3">
                                                    <div className="avatar placeholder">
                                                        <div className="w-8 h-8 rounded-full bg-gradient-to-br from-gray-100 to-gray-200 text-gray-600 dark:text-gray-300 flex items-center justify-center text-xs font-bold shadow-sm">
                                                            <span>{log.user_name ? log.user_name.charAt(0) : '?'}</span>
                                                        </div>
                                                    </div>
                                                    <span className="font-medium text-sm text-gray-700 dark:text-gray-200">{log.user_name || 'Système'}</span>
                                                </div>
                                            </td>
                                            <td>
                                                 <div className="badge badge-ghost badge-sm font-mono text-xs opacity-70 bg-gray-100 dark:bg-slate-800/50 border-gray-200 dark:border-slate-700">
                                                    {log.ip_address}
                                                </div>
                                            </td>
                    ...
                    {/* Pagination */}
                    <div className="p-4 border-t border-gray-100 dark:border-slate-700/50 flex justify-between items-center bg-gray-50 dark:bg-slate-900/50/30">
                        <Button 
                            variant="ghost"
                            size="sm"
                            disabled={page === 0}
